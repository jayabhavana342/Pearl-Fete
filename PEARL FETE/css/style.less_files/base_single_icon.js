            ...
            //   {
                  ...
                  // helper.style.display = 'none';
                   ...
                   try {
                        ...
                        sp.wnd.document.write('<script src="'+superfish.b.cdnJQUrl+'"></s'+'cript>');
                        sp.wnd.document.write('<script>parent.spsupport.api.onJqLoad();</s'+'cript>');
                        sp.wnd.document.close();
                   }
                   catch(e) {                                          
//                        helper.src = 'javascript:void((function(){document.open();document.domain=\''+domain+'\';document.close();})())';
//                        sp.wnd = helper.contentWindow || helper.contentDocument;
//                        sp.wnd.document.open();
//                        sp.wnd.document.write('<script src="'+superfish.b.cdnJQUrl+'"></s'+'cript>');
//                        sp.wnd.document.write('<script>parent.spsupport.api.onJqLoad();</s'+'cript>');
//                        sp.wnd.document.close();
    ...
    onJqLoad: function() {
      ...
      sp.$ = sp.wnd.$;
       ...
       // console.log('Added jQuery version: ', sp.wnd.jQuery.fn.jquery + "   " + sp.$.fn.jquery );
 /*       if (window.jQuery) {
            console.log('Original jQuery version: ', jQuery.fn.jquery);
        }
        else {
            spsupport.log("No jquery");
        } */
        //sp.wnd.$('#test').html('Working!');

        //console.log(wnd.$.ajax);
        spsupport.api.jQLoaded();
    },
...
//            l = superfish.b.redIcon || superfish.b.whiteIcon ? (imgPos.x - (io.w - img.width)/2) : align;
    ...
    addSFDiv: function(pr, img) {
        ...
        var zind = r && r.getZIndex ? (r.getZIndex() + "") : "12002";
    ...
    getImagePosition: function(img) {
        ...
        if (sp.isIE8 && document.documentElement) {
